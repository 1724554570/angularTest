    ...
    function ($stateProvider, $httpProvider) {
        ...
        $stateProvider
                ...
                .state('app.home', {
                    ...
                    views: {
                        content: {
                            templateUrl: paths.view + 'app/index.tpl',
                ...
                .state('article.add', {
                    ...
                    views: {
                        content: {
                            templateUrl: paths.view + 'article/add.tpl',
                ...
                .state('article.list', {
                    ...
                    views: {
                        content: {
                            templateUrl: paths.view + 'article/list.tpl',
                ...
                .state('article.detail', {
                    ...
                    views: {
                        content: {
                            templateUrl: paths.view + 'article/detail.tpl',
                ...
                .state('issue.home', {
                    ...
                    views: {
                        content: {
                            templateUrl: paths.view + 'issue/list.tpl',
                            controller: 'dynamicCtrl_list'
                        },
                        content2: {}
                    }
                })
                ...
                .state('about.home', {
                    ...
                    views: {
                        content: {
                            templateUrl: paths.view + 'about/detail.tpl',
