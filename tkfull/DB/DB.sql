...
CREATE TABLE `tk_admin` (
  ...
  `ctime` varchar(20) DEFAULT NULL,
  `acluser` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of tk_pro
-- ----------------------------
INSERT INTO `tk_pro` VALUES ('1', '测试改版。', '&lt;p&gt;&lt;img src=&quot;/ueditor/php/upload/image/20161117/1479365528114395.jpg&quot; title=&quot;1479365528114395.jpg&quot; alt=&quot;page12-1.jpg&quot;/&gt;&lt;/p&gt;', '1479365899', '1479365899', '2', '1', '1');
